        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Filtro de Informes Sub Comisiones</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <form role="form" action="/Informes/Filtrar" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control" name="id_subcom">
                                    @foreach($subcomisiones as $subcomisiones)
                                        <option value="{{ $subcomisiones->idComisiones }}">
                                            {{ $subcomisiones->nombreComisiones  }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
